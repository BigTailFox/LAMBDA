...
class BayesOpt:
    """The naiive bayession optimization algorithm.
    ...
    Example usage:
        bo = BeyesOpt(f=f, lb=lb, ub=ub, n_init=n_init, max_evals=max_evals)
        bo.optimize()  # Run optimization
        X, fX = bo.X, bo.fX  # Evaluated points
    """
    ...
    def optimize(self, iters=1):
        ...
        cnt = 0
        while self.n_evals < self.max_evals and cnt < iters:
            # Warp inputs
